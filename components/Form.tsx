    ...
    <div className="flex justify-between items-center gap-2">
      ...
      {boardCreating ? (
        <div className="relative">
          <button
            className="bg-blue-700 text-white px-3 py-1 rounded-md font-[600] hover:cursor-pointer w-[70px]"
        ...
        <button
          className="bg-blue-700 text-white px-3 py-1 rounded-md font-[600] hover:cursor-pointer relative w-[70px]"
